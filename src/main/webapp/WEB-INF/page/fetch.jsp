        ...
        <nav id="site-navigation" class="main-navigation" role="navigation">
            ...
            <ul class="nav-menu">
                ...
                <li style="margin-right: 10px;" class="menu-item menu-item-type-taxonomy menu-item-object-custom right">
                    <i class="qq-icon" style="cursor: pointer;"
    ...
    <div id="content" style="width: auto;">
        ...
        <div id="post-2" class="post-2 page type-page status-publish hentry">
            <div class="entry entry-content">
                ...
                <form id="fetchForm" class="largeinput" accept-charset="UTF-8" method="POST" target="_blank"
                      action="${domain }get.html">
                    <div class="control-group">
                        <label class="control-label" for="name">提取数量</label>
                        <div class="controls">
                            <input id="num" type="text" name="num" class="span4 required" value="100"
                                   placeholder="填入数字,一次做多提取10000个">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="num" type="text" name="country" class="span4 required" value=""
                                   placeholder="国家，比如中国">
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="submit" style="margin-top: 22px; ">
                        <span class="smallbutton"><a id="postcontent"
                                                     href="javascript:fetchForm.submit();">提取IP</a></span>&nbsp;&nbsp;
